        ...
        <div className="space-y-8">
          {steps.map((s, i) => (
            <div key={i} className="flex gap-5 items-start">
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-green-600 text-white font-bold shrink-0">
                {i + 1}
              </div>

              <div>
                <h4 className="font-semibold text-lg text-white-900">
                  {s.title}
                </h4>
