...
import { getFeatures } from "../../data/landingContent";

const featureIconsByIndex: LucideIcon[] = [Truck, MapPin, Satellite, CreditCard];
const featureRoutes = [
  "/features/smart-collection",
  "/features/tracking",
  "/features/gps",
  "/features/payments",
];
    ...
    <section className="px-6 py-14">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((f, i) => {
            const Icon = featureIconsByIndex[i] ?? Truck;
            ...
            return (
              <motion.div
                ...
                onClick={() => navigate(featureRoutes[i])}
                className={`p-6 rounded-2xl backdrop-blur-md border shadow-xl cursor-pointer text-white ${cardColors[i % cardColors.length]}`}
              >
